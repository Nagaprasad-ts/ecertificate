...
class EmailLogController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        if ($request->filled('batch_id'))           $statsQuery->where('batch_id', $request->batch_id);
        if ($request->filled('event_edition_id'))   $statsQuery->where('event_edition_id', $request->event_edition_id);
        elseif ($request->filled('event_id'))       $statsQuery->where('event_id', $request->event_id);
