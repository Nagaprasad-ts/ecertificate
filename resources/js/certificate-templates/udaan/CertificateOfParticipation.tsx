...
export default function CertificateOfParticipation({ participant }: CertificateProps) {
    return (
        <>
            <style>{`
            ...
            <div style={{
                ...
                >
                    ...
                    <img
                        src="/certificate-backgrounds/udaan/udaan-certificate-of-participation-2026.jpg"
                        alt=""
                        style={{
                            position: 'absolute',
                            inset: 0,
                    ...
                    <div style={{
                        ...
                        <p style={{ margin: 0 }}>
                            ...
                            <strong>UDAAN Intra-Institutional Business Plan Competition 2026</strong>{' '}
                            organised by the{' '}
                            <strong>
